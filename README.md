...
Готовые релизы доступны на странице [Releases](https://github.com/yourusername/PDFAnnotator/releases):
- Скачайте последнюю версию `PDFAnnotator-win-x64.zip`
- Распакуйте архив
- Запустите `PdfAnnotator.app.exe`
- .NET Runtime не требуется — сборка полностью автономная
...
2. GitHub Actions автоматически:
   - Соберёт проект в Release конфигурации
   - Запустит тесты
   - Создаст самостоятельную сборку для Windows x64
   - Упакует в ZIP архив
   - Опубликует релиз на GitHub с приложенным файлом

Рабочий процесс также можно запустить вручную из вкладки Actions в GitHub.
